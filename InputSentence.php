            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a id="input" class="nav-link" href="InputSentence.php">Input Texte <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a id="graphique" class="nav-link" href="graphique.php">Graphique</a>
                    </li>
                    <li class="nav-item">
